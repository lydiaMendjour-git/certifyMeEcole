...
import IntegrationBd from '../pages/university/IntegrationBd';
import IntegrationEtudiant from '../pages/university/IntegrationEtudiant'; // Importer le composant IntegrationEtudiant
...
const Header = () => {
  ...
  const handleOptionSelect = (option) => {
    ...
    if (option === 'faculty') {
      router.push('/university/IntegrationBd');
    } else if (option === 'students') {
      router.push('/university/IntegrationEtudiant'); // Afficher l'intégration des étudiants
    }
  };
