...
//3.read the 'GestionActeur.sol' and the 'GestionDiplome.sol' from the 'Contracts' folder
...
const gestionDiplomeSource = fs.readFileSync(gestionDiplomePath, 'utf8');
